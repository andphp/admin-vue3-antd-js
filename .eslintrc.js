module.exports = {
  ...
  plugins: ["html", // 插件，此插件用于识别文件中的js代码，没有MIME类型标识没有script标签也可以识别到，因此拿来识别.vue文件中的js代码
  ],
  rules: {
    /**
     * 代码中可能的错误或逻辑错误
    ...
    // indent: ["error", 2, { SwitchCase: 1 }], // 两个空格缩进ent: ["error", 2, { SwitchCase: 1 }], // 两个空格缩进
    indent: [
      "error",
      2,
      {
    ...
    "multiline-comment-style": ["error", "bare-block"], // 强制对多行注释使用特定风格
