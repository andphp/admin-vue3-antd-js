    ...
    children: [
      {
        ...
        component: "@/views/AeronauticalData/AirportManagement/index",
        meta: {
          title: "机场管理",
          description: "机场管理",
        ...
        children: [
          {
            path: "Airport",
            name: "Airport",
            component: "@/views/AeronauticalData/AirportManagement/airport",
            meta: {
              title: "机场管理",
              description: "机场管理",
              icon: "caidanlan-kucun-kucunchanpinliebiao",
          ...
          },
          {
            path: "Airline",
            name: "Airline",
            component: "@/views/AeronauticalData/AirportManagement/airline",
            meta: {
              title: "航司管理",
              description: "航司管理",
              icon: "caidanlan-kucun-kucunchanpinliebiao",
...

  {
    ...
    children: [
      ...
      },
      {
        path: "departments",
        name: "departments",
        component: "@/views/system/departments",
        meta: {
          title: "部门管理",
          description: "部门管理",
          icon: "caidanlan-kucun-kucunchanpinliebiao",
      ...
      },
      {
        path: "subject",
        name: "subject",
        component: "@/views/system/subject",
        meta: {
          title: "收支科目",
          description: "收支科目",
          icon: "caidanlan-kucun-kucunchanpinliebiao",
    ...
    children: [
      {
        path: "table",
        name: "table",
        component: "@/views/components/table",
        meta: {
          title: "表格",
          hidden: false,
          alwaysShow: true,
